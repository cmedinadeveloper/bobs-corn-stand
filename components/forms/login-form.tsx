    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold text-corn-yellow-900">
                  Welcome back to Bob&apos;s Corn Stand
                </h1>
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button
                  variant="outline"
                  type="button"
                  className="w-full border-corn-yellow-300 text-corn-yellow-700 hover:bg-corn-yellow-50 hover:text-corn-yellow-800"
                >
          ...
          <div className="bg-corn-green-50 relative hidden md:block">
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
              <div className="text-6xl mb-4">🌽</div>
              <h2 className="text-2xl font-bold text-corn-green-900 mb-2">
                Welcome Back!
              </h2>
              <p className="text-corn-green-700 mb-4">
                Ready to order some fresh corn? Bob&apos;s got the best ears in
                town!
              </p>
              <div className="bg-white/80 rounded-lg p-4 border border-corn-green-200">
                <h3 className="font-semibold text-corn-green-800 mb-2">
                  🚀 API Challenge
                </h3>
                <p className="text-sm text-corn-green-700">
                  Remember: Only 1 corn per customer per minute!
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="text-corn-yellow-600 *:[a]:hover:text-corn-orange-700 text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4 *:[a]:text-corn-orange-600">
