    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold text-corn-yellow-900">
                  Join Bob&apos;s Corn Stand
                </h1>
                <p className="text-corn-yellow-700 text-balance">
                  Create your account to start ordering fresh corn
                </p>
              </div>
              ...
              <div className="grid gap-3">
                <Label htmlFor="firstName" className="text-corn-yellow-800">
                  First Name
                </Label>
                <Input
                  id="firstName"
              ...
              <div className="grid gap-3">
                <Label htmlFor="lastName" className="text-corn-yellow-800">
                  Last Name
                </Label>
                <Input
                  id="lastName"
              ...
              <div className="grid gap-3">
                <Label
                  ...
                  className="text-corn-yellow-800"
                >
                  Confirm Password
                </Label>
                <Input
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  type="checkbox"
                  {...register("terms")}
                  className="rounded border-corn-yellow-300 text-corn-yellow-600 focus:ring-corn-yellow-600"
                />
                <Label htmlFor="terms" className="text-sm text-corn-yellow-700">
                  I agree to the{" "}
                  <Link
                    href="/terms"
          ...
          <div className="bg-corn-yellow-50 relative hidden md:block">
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
              <div className="text-6xl mb-4">🌽</div>
              <h2 className="text-2xl font-bold text-corn-yellow-900 mb-2">
                Fresh Corn Awaits!
              </h2>
              <p className="text-corn-yellow-700">
                Join thousands of happy customers who enjoy Bob&apos;s premium
                corn delivery service.
              </p>
            </div>
          </div>
        </CardContent>
